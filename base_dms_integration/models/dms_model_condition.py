...
class DmsModelCondition(models.Model):
    _name = 'dms.model.condition'
    _description = 'DMS Condition'
    _order = 'sequence, id'
    ...
    dms_configuration_id = fields.Many2one(
        comodel_name='dms.integration',
    )
    ...
    model = fields.Char(related='dms_configuration_id.model_id.model', store=True)

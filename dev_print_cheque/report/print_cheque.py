...
class print_check(models.AbstractModel):
    ...
    def amount_word(self, obj):
        if obj.partner_id and obj.partner_id.lang:
            amt_word = obj.with_context(lang=obj.partner_id.lang).currency_id.amount_to_text(obj.amount)
        else:
        ...
        lst_len = len(lst)
        amt_word_list = []
        step = (int(obj.cheque_formate_id.word_in_f_line) + 1) if obj.cheque_formate_id.word_in_f_line else lst_len - 1

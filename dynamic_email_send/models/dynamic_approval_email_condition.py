...
class EmailApprovalCondition(models.Model):
    _name = 'dynamic.approval.email.condition'
    _description = 'Email Approval Condition'
    _order = 'sequence, id'
    ...
    email_config_id = fields.Many2one(
        comodel_name='dynamic.email.configuration',
    )
    ...
    company_id = fields.Many2one(
        ...
        readonly=True,
        related='email_config_id.company_id',
        store=True,
    )
    model = fields.Char(related='email_config_id.model_id.model', store=True)

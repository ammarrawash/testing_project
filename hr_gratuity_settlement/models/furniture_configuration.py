...
class FurnitureConfiguration(models.Model):
    """ Model for gratuity furniture configuration details """
    _name = 'furniture.configuration'
    _inherit = ['mail.thread', 'mail.activity.mixin']
    _description = "Furniture Configuration"
    _rec_name = "name"

    furniture_accounting_configuration_id = fields.Many2one('hr.gratuity.accounting.configuration')
    ...
    percentage = fields.Float(default=1, string='Terminated/Resigned Percentage')
    percentage_twr = fields.Float(default=1, string='Terminated with Reason Percentage')

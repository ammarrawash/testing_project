odoo.define('hr_org_chart_custom.OrgChart', function (require) {
"use strict";
        ...
        return this._getOrgData().then(function (orgData) {
            ...
            self.$('[data-toggle="popover"]').each(function () {
                $(this).popover({
                    html: true,
                    title: function () {
                        var $title = $(QWeb.render('hr_org_chart_custom.hr_orgchart_emp_popover_title', {
                            employee: {
                                name: $(this).data('emp-name'),
                                id: $(this).data('emp-id'),
                                arabic_name: $(this).data('emp-arabic-name'),
                                language: $(this).data('emp-lang'),
                            },
                        }));
                        $title.on('click',

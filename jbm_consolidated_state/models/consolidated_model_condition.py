...
class DmsModelCondition(models.Model):
    _name = 'consolidated.model.condition'
    _description = 'Consolidated Model Condition'
    _order = 'sequence, id'
    ...
    consolidated_configuration_id = fields.Many2one(
        comodel_name='consolidated.state',
    )
    ...
    model = fields.Char(related='consolidated_configuration_id.model_id.model', store=True)
